...
export class SharedDataService {
  testData = [
    ...
    {
      descr:
        'which example to define custom event with Boolean argument with code and passing data to parent component',
      quesNo: 7,
      options: [
        {
    ...
    {
      descr:
        'Correct  syntax to bind custom CSS class (e.g. highlighted) to a <div> tag.',
      quesNo: 9,
      options: [
        {
  ...
  senhaData = [
    { id: 1, senha: 'P1245', prioritaria: true },
    { id: 2, senha: '21434', prioritaria: false },
    { id: 3, senha: 'P45757', prioritaria: true },
    { id: 4, senha: '57454', prioritaria: false },
    { id: 5, senha: 'P45745', prioritaria: true },
    { id: 6, senha: '457698', prioritaria: false },
  ];

  senhasChamadasData = [];
  getSenhasChamadas() {
    return this.senhasChamadasData;
  }
  setSenhaCahamada(senha) {
    this.senhasChamadasData.push(senha);
  }
  getSenhas() {
    return this.senhaData;
  }
